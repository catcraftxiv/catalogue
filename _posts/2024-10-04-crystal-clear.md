...
<div class="slideshow-container">
  ...
  <div class="mySlidesImgCarousel fadeImgCarousel">
    <div class="numbertextImgCarousel">1 / 3</div>
    <img src="assets/images/crystal-clear/pic1.jpg" style="width:100%">
    <div class="textImgCarousel">Caption Text</div>
  </div>

  <div class="mySlidesImgCarousel fadeImgCarousel">
    <div class="numbertextImgCarousel">2 / 3</div>
    <img src="assets/images/crystal-clear/pic2.jpg" style="width:100%">
    <div class="textImgCarousel">Caption Two</div>
  </div>

  <div class="mySlidesImgCarousel fadeImgCarousel">
    <div class="numbertextImgCarousel">3 / 3</div>
    <img src="assets/images/crystal-clear/pic3.jpg" style="width:100%">
    <div class="textImgCarousel">Caption Three</div>
  </div>

  <!-- Next and previous buttons -->
  <a class="prevImgCarousel" onclick="plusSlides(-1)">&#10094;</a>
  <a class="nextImgCarousel" onclick="plusSlides(1)">&#10095;</a>
</div>
<br>

<!-- The dots/circles -->
<div style="text-align:center">
  <span class="dotImgCarousel" onclick="currentSlide(1)"></span>
  <span class="dotImgCarousel" onclick="currentSlide(2)"></span>
  <span class="dotImgCarousel" onclick="currentSlide(3)"></span>
</div>
